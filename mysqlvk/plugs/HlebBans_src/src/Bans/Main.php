...
class Main extends PluginBase implements Listener
{
   ...
   #         ebal '0'; // vk_id не найден
    ...
    $msg = urlencode($msg);
    $topic_id = '53828441'; // ID обсуждения
    $group_id = '229239390'; // ID вашей группы, без минуса
    $from_group = '1'; # от имени сообщества
    $token = 'vk1.a.bCYPtQuE2YA3sP-9amAP1Emkfbkxf9mzu013-SI8JVUw8yPpT4CAYaQ7rJlooznBCvXUI5CEXBeEIkCxjwDxWHchGZMa97lLmSH5yhvjbYf8g_dOBBKErFvBMMi1wzIYIdezn2d_eokYVYgyIW6Svjr_6qAa996AXJrlYj7zufEaVYr2_0rRlFdSwcs9qSWD4y93hDQcobygLFr1B6Wv1w';
