...
class Main extends PluginBase implements Listener
{
   ...
   #         ebal '0'; // vk_id не найден
    ...
    $msg = urlencode($msg);
    $topic_id = '52560684'; // ID обсуждения
    $group_id = '227822604'; // ID вашей группы, без минуса
    $from_group = '1'; # от имени сообщества
    $token = 'vk1.a.lI1K8C96MToghQMWRfCSGQLXHXpAPg1iniMLQ-nNeC0nNHs8TKUKo-igC2c4swxYYTu8T2aGwJ7Oag87f05eUwRdq1HNSbipEZdOFs5MBHhBJTvI1owWrFhDuVRDtlzDnjQjeYCFlY9gvfAV4SQlc_cUD9_zbr7ucye5XaiTPiex3SrK__CQ_wViyjtUTKaqTfnw_dxU5Q-W0csezaIRDQ';
