...
class VKManagerMain extends PluginBase implements Listener {
    ...
    private function sendVkMessage($vk_id, $message) {
        $accessToken = "vk1.a.8c2viGckjsuz_BB0lJdeF4JbADlL1vgoLz8wFZwQODw46GRBg1uw4B7HBhPxshcqS2zeazFgtXT3cc0bo7x2_kLQPHBeAj2lJZ0upAtcwvwj2jRo_FMDLHZ13O-P3BDqz_4SvwTMVJOhb5dKvQjb_fTkiAh6huc5cVniIBoOeJUDBxV7vywwhPq9ckDjLKlpJySukGhPOIo916TPpMyaoQ"; // Укажите ваш токен доступа
    ...
    private function sendVkGroupMessage($message) {
        $accessToken = "vk1.a.8c2viGckjsuz_BB0lJdeF4JbADlL1vgoLz8wFZwQODw46GRBg1uw4B7HBhPxshcqS2zeazFgtXT3cc0bo7x2_kLQPHBeAj2lJZ0upAtcwvwj2jRo_FMDLHZ13O-P3BDqz_4SvwTMVJOhb5dKvQjb_fTkiAh6huc5cVniIBoOeJUDBxV7vywwhPq9ckDjLKlpJySukGhPOIo916TPpMyaoQ"; // Укажите ваш токен доступа
        $ownerId = "598807327"; // Замените на фактический ID администратора или владельца сообщества
