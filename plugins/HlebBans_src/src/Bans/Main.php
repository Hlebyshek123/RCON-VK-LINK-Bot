...
class Main extends PluginBase implements Listener
{
   ...
   #         ebal '0'; // vk_id не найден
    ...
    $group_id = '225643362'; // ID вашей группы, без минуса
    $from_group = '1'; # от имени сообщества
    $token = 'vk1.a.MiuRvqwfVo3VEMf_rrbAGZjdKqZL9sHu4YZbK_ok9cX0W-HVCnRfhmP9umZDtWbvehcN4MnGFSxCr_rLeG2v03TUQYZEBbLkx4PgGsDS5Jzek8WKVKT4K3rqCykIqxybZWe5v9Tq88BpZ51abUmHrZnU-K3PSkIJtO0dKzcwwxTaDLfniYjj4tzU7RS8_BaT86onTxqMH1uLQOfpMblivg';
