            ...
            if event.type == VkBotEventType.MESSAGE_NEW:
                ...
                if message_text.startswith('/акк'):
                    try:
                        ...
                        send_vk_message(vk_session, user_id, "🚫 не выбраны аргументы. Введите /акк [список, выбрать, профиль, принять, отклонить, восстановить, разбан]")
                        continue
                ...
                if message_text.startswith('/vk-info'):
                    ...
                    if len(args) == 3:
                        ...
                        if option == 'рассылка':
                            ...
                            conn.commit()
                            send_vk_message(vk_session, user_id, f"⚙️ | Опция 'IP' для аккаунта {selected_account} успешно изменена.")
