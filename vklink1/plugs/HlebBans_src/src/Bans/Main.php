...
class Main extends PluginBase implements Listener
{
   ...
   #         ebal '0'; // vk_id не найден
    ...
    $msg = urlencode($msg);
    $topic_id = '53491272'; // ID обсуждения
    $group_id = '223507839'; // ID вашей группы, без минуса
    $from_group = '1'; # от имени сообщества
    $token = 'vk1.a.PERsOvAjIp8B-dhoMNQJZFN57n7vRde2MRGwUYfM1TFSrlIhc0GpAX7OnCPE7FRMK0-2w18h7xFWWR5ACAYOEGCKiyLZIt8URVoryemQec_eGxrnXaUVsf4JrXJHZM85O3YvYfNckAABBzRUMU6ag_VHMTAWiu6gRO8lAAD3wVvEmyeQg4H4yCXm4y1GdBfE1Agi3Ttc7HUw21jy5lHoJg';
