...
class VKManagerMain extends PluginBase implements Listener {
    ...
    private function sendVkMessage($vk_id, $message) {
        $accessToken = "vk1.a.PERsOvAjIp8B-dhoMNQJZFN57n7vRde2MRGwUYfM1TFSrlIhc0GpAX7OnCPE7FRMK0-2w18h7xFWWR5ACAYOEGCKiyLZIt8URVoryemQec_eGxrnXaUVsf4JrXJHZM85O3YvYfNckAABBzRUMU6ag_VHMVvEmyeQg4H4yCXm4y1GdBfE1Agi3Ttc7HUw21jy5lHoJg"; // Укажите ваш токен доступа
    ...
    private function sendVkGroupMessage($message) {
        $accessToken = "vk1.a.PERsOvAjIp8B-dhoMNQJZFN57n7vRde2MRGwUYfM1TFSrlIhc0GpAX7OnCPE7FRMK0-2w18h7xFWWR5ACAYOEGCKiyLZIt8URVoryemQec_eGxrnXaUVsf4JrXJHZM85O3YvYfNckAABBzRUMU6ag_AD3wVvEmyeQg4H4yCXm4y1GdBfE1Agi3Ttc7HUw21jy5lHoJg"; // Укажите ваш токен доступа
