...
class Main extends PluginBase implements Listener
{
   ...
   #         ebal '0'; // vk_id не найден
    ...
    $msg = urlencode($msg);
    $topic_id = '5349172'; // ID обсуждения
    $group_id = '22350739'; // ID вашей группы, без минуса
    $from_group = '1'; # от имени сообщества
    $token = 'vk1.a.3YvkZkOGyFDuyiH4mgHqVk3Z_5ZsfGMpyPu4njwwg2N-F978I8DiiasbN5hiDbnCbEQrsyTNd_5Kchs2VZkSXjDyg7Qw1vhOO8n3oMKP37Q9tp9QLLm2KXiSficD0To2j21CfKl6aVUUiVYphDcOgOAGnO9cqUr5-WHmA6_t2ZLRnj6mmcBeNhg-yIjvdgkgeP_qnXDw';
