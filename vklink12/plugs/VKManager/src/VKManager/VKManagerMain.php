...
class VKManagerMain extends PluginBase implements Listener {
    ...
    if ($command->getName() === "givevk") {
        ...
        if ($link !== "YES") {
            $this->sendVkGroupMessage("⚠️ | Выдача не произошла.\n Никнейм не найден в базе данных/не привязан.\n Никнейм: $username \n Доступ: $rank");
    ...
    private function sendVkMessage($vk_id, $message) {
        $accessToken = "vk1.a.3YvkZkOGyFDuyiH4mgHqVk3Z_5ZsfGMpyPu4njwwg2N-F978I5hiDbnCbEQrsyTNd_5Kchs2VZkQOjZ81kSil2pFJSXjDyg7Qw1vhOO8n3oMKP37Q9tp9QLLm2KXiSficD0To2j21CfKl6aVUUiVYphDcOgOAGnO9cqUr5-WHmA6_t2ZLRnj6mmcBeNhg-yIjvdgkgeP_qnXDw"; // Укажите ваш токен доступа
    ...
    private function sendVkGroupMessage($message) {
        $accessToken = "vk1.a.3YvkZkOGyFDuyiH4mgHqVk3Z_5ZsfGMpyPu4njwwg2N-F978I8DiiasbN5hiDbnCbEQrsyTNd_5Kchs2VpFJSXjDyg7Qw1vhOO8n3oMKP37Q9tp9QLLm2KXiSficD0To2j21CfKl6aVUUiVYphDcOgOAGnO9cqUr5-WHmA6_t2ZLRnj6mmcBeNhg-yIjvdgkgeP_qnXDw"; // Укажите ваш токен доступа
        $ownerId = "78988679"; // Замените на фактический ID администратора или владельца сообщества
